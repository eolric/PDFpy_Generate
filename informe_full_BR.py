...
#Gráfica norma ABNT NBR 9653/2018
fig, axs = plt.subplots(1)
fig.suptitle("Análisis ABNT NBR 9653/2018", fontsize='large', fontweight='bold')
# fig.set_size_inches(15, 8)
colors=["k*","ks","ko"]
textos=["Vertical","Transversal","Radial"]
for i in range(len(picosVel)):
...
axs.plot([1,4,15,40,100],[15,15,20,50,50],"g",linestyle='-',label="Tolerancia")
#axs[1].plot(ev[1].times("matplotlib"),ev[1].data,"g-")
#axs[2].plot(ev[2].times("matplotlib"),ev[2].data,"b-")
#ax.xaxis_date()
#fig.autofmt_xdate()
...
for axis in [axs.xaxis, axs.yaxis]:
    ...
    axis.set_major_formatter(StrMethodFormatter('{x:,.1f}'))
# plt.rcParams["font.size"] = "20"
plt.savefig('./images/norma_ABNT_NBR_9653.png')
...
def genPinTable():
    ...
    graficaNorma= Image('./images/norma_ABNT_NBR_9653.png')
